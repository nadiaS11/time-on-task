...
const PeopleSection = (props) => {
  return (
    <div class="my-20 grid p-5 gap-5 md:gap-10 sm:grid-cols-2  mx-auto max-w-screen-xl">
      <div class="py-14 px-16  shadow-lg shadow-blue-200">
        <svg
        ...
        <p class="mt-4 font-semibold py-3 text-3xl md:text-5xl leading-normal tracking-tight ">
      ...
      <div class="py-14 px-16 shadow-lg shadow-blue-200 drop-shadow-md">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="mt-2  ">
          Juggle freelance projects effortlessly with Time-On-Task. Tailored for
          freelancers, our platform streamlines tasks, clients, and deadlines
